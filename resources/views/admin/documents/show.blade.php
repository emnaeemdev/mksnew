                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" 
                                           value="{{ route('content.show', [app()->getLocale(), $document->section->slug, $document->publicId()]) }}" 
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                @if($document->is_published)
                                    <a href="{{ route('content.show', [app()->getLocale(), $document->section->slug, $document->publicId()]) }}" 
