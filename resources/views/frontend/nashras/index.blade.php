    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <form method="GET" action="{{ route('frontend.nashras.index') }}" class="row g-3">
                        <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                        <div class="card bg-info text-white">
                            <div class="card-body text-center">
                                ...
                                <h4>{{ $nashras->where('pdf_file', '!=', null)->count() }}</h4>
                    ...
                    <div class="col-md-3">
                        <div class="card bg-warning text-white">
                            <div class="card-body text-center">
                                ...
                                <h4>{{ $nashras->where('google_drive_url', '!=', null)->count() }}</h4>
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="nashrasTabContent">
                                        ...
                                        <div class="col-lg-4 col-md-6 mb-4">
                                            <div class="card h-100 shadow-sm hover-shadow">
                                                ...
                                                <div class="card-body d-flex flex-column">
                                                    <h5 class="card-title text-primary">{{ $nashra->title_ar }}</h5>
                                                    
                                                    @if($nashra->subtitle_ar)
                                                        <p class="card-text text-muted small">{{ $nashra->subtitle_ar }}</p>
                                                    @endif
                                                    
                                                    @if($nashra->content_ar)
                                                        <p class="card-text flex-grow-1">
                                                            {{ Str::limit(strip_tags($nashra->content_ar), 100) }}
                                                        </p>
                                                    @endif
                            ...
                            <div class="tab-pane fade" id="timeline-view" role="tabpanel">
                                <div class="timeline">
                                    @foreach($nashras as $index => $nashra)
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                                            <h6 class="card-title text-primary mb-0">{{ $nashra->title_ar }}</h6>
                                                            <small class="text-muted">{{ $nashra->formatted_published_date }}</small>
                                                        </div>
                                                        
                                                        @if($nashra->subtitle_ar)
                                                            <p class="card-text small text-muted mb-2">{{ $nashra->subtitle_ar }}</p>
                                                        @endif
                                                        
                                                        @if($nashra->content_ar)
                                                            <p class="card-text">{{ Str::limit(strip_tags($nashra->content_ar), 80) }}</p>
                                                        @endif
