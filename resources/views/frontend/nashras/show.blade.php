...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <!-- يمين: عرض Google Sheets (3/4 من العرض) -->
        <div class="col-lg-9">
        ...
        <!-- يسار: أزرار العودة وملف PDF والنشرات ذات الصلة (1/4 من العرض) -->
        <div class="col-lg-3">
            <!-- زر العودة لقائمة النشرات -->
    ...
    function displaySheetsData(data) {
        ...
        if (Object.keys(data).length > 0) {
            ...
            Object.keys(data).forEach((sheetName, index) => {
                ...
                // طرح 2 من عدد الصفوف لاستبعاد صفوف الهيدر
                const actualRowCount = Math.max(0, sheetData.length - 2);
                html += `
