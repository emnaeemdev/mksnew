        ...
        <div class="col-12 col-sm-6 col-lg-4">
            <div class="post-card">
                <a href="{{ route('content.show', [app()->getLocale(), $post->category->slug, $post->id]) }}" class="text-decoration-none">
                    ...
                    <img src="{{ asset('storage/' . $post->featured_image) }}" class="post-image post-image-hover" alt="{{ $post->title }}" loading="lazy" decoding="async">
                    @else
                    <img src="{{ asset('images/placeholder.jpg') }}" class="post-image post-image-hover" alt="{{ $post->title }}" loading="lazy" decoding="async">
                    @endif
                </a>
