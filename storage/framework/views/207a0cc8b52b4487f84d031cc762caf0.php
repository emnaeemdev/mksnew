<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
    <div class="container">
        <a class="navbar-brand fw-bold" href="<?php echo e(route('home')); ?>">
            ...
            <img alt="Logo" src="<?php echo e(asset('images/logo-arabic-header_mks.png')); ?>" class="footer_logo" style="width: 100%;" />
        </a>
...
<!-- <div style="height: 80px;"></div> --><?php /**PATH C:\xampp\htdocs\mksnew\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>